...
CREATE TABLE `user` (
  ...
  `departmentId` char(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部门ID',
  `departmentName` char(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部门名称',
  `job` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '岗位',
  `status` int(11) DEFAULT '1' COMMENT '1: 在职 2：离职 3: 试用期',
  `roleId` int(11) DEFAULT NULL COMMENT '角色ID',
  `roleName` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '角色名称',
...
INSERT INTO `user` (`id`, `userName`, `nickName`, `userPwd`, `userEmail`, `mobile`, `gender`, `departmentId`, `departmentName`, `job`, `status`, `roleId`, `roleName`, `createTime`, `lastLoginTime`, `remark`) VALUES
(5, 'admin', '张宝湘', '7e5266a172a55f69d1d6e14159d03594', 'admin@qq.com', '13715261163', 0, '3', NULL, '', 1, 1, '', '2022-08-27 22:36:18', '2022-08-27 22:36:18', '该用户为系统管理员');
